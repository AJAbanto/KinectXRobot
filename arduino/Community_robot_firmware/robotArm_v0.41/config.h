...
#define LOW_SHANK_LENGTH 320.0
#define HIGH_SHANK_LENGTH 320.0

#define END_EFFECTOR_OFFSET 0.0 // LENGTH FROM UPPER SHANK BEARING TO MIDPOINT OF END EFFECTOR IN MM
...
//STEPPER SETTINGS:
#define MICROSTEPS 4 // MICROSTEPPING CONFIGURATION ON RAMPS1.4
...
//GEAR RATIO SETTINGS
#define MOTOR_GEAR_TEETH 1.0 // 20.0 FOR 20SFFACTORY BELT VERSION   9.0 FOR FTOBLER GEAR VERSION
#define MAIN_GEAR_TEETH 36.0 // 90.0 FOR 20SFFACTORY BELT VERSION   32.0 FOR FTOBLER GEAR VERSION
...
#define SPEED_PROFILE 1 // OPTIONS BELOW
